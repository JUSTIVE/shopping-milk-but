...
export const HAPPY_MART: () => Mart = () =>
  MART(SOME_CARTS(), MART_INVENTORY_WITH_MILK())
export const NO_CART_MART: () => Mart = () =>
  MART(NO_CARTS, MART_INVENTORY_WITH_MILK())
export const NO_MILK_MART: () => Mart = () =>
  MART(SOME_CARTS(), MART_INVENTORY_NO_MILK())
